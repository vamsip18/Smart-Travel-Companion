...
const LiveEvents = ({ location, date ,userid}) => {
  ...
  const fetchEvents = async () => {
    try {
      setError("");
      setLoading(true);
      const response = await axios.get("https://smart-travel-companion-udlt.onrender.com/live-events", {
  ...
  const fetchSavedEvents = async () => {
    ...
    try {
      const response = await axios.get(`https://smart-travel-companion-udlt.onrender.com/saved-events/${userid.userid}`);
  ...
  const toggleSaveEvent = async (event) => {
    ...
    try {
      if (savedEvents.has(eventId)) {
        await axios.post("https://smart-travel-companion-udlt.onrender.com/delete-event", { userid, eventId });
        setSavedEvents((prev) => {
        ...
        await axios.post("https://smart-travel-companion-udlt.onrender.com/save-event", {
          userid,
          eventId: event.id,
